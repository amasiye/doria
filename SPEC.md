...
- Broader native backend design and implementation beyond the Stage 2d smoke target.
- Native-oriented IR implementation when native code generation needs it.
- Broader native code generation and standalone executable production beyond the Stage 2d smoke target.
